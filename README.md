This project was create to implement React with Redux into an application. A fun application where you create you your own memes collected from [imgflip API](https://api.imgflip.com/).
